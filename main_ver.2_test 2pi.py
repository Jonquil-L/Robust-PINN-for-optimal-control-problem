...
# ===========================================================================
# ===========================================================================
# Manufactured Solution Helpers (更换为高频双峰双谷解)
# ===========================================================================
def y_true(x):
...
def f_source(x, alpha):
    """
    根据状态方程: -Δȳ = f + u_d - α⁻¹p̄
    因为在真实解处 u_d = α⁻¹p̄ (两者抵消)，且 Δ(sin(2πx)sin(2πy)) = -8π² sin(2πx)sin(2πy)
    所以 f = -Δy_true = 8π² y_true
    """
